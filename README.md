...
- **v1.11** — preokret redosleda, jer je alat davao tačan a bezličan tekst. Prvo što se učitava više nije pravilnik nego **glas**: 4,4 KB stvarnih domaćih rečenica, grupisanih po tome **šta svaka rizikuje**. Kapija traži **opkladu** umesto dozvole. Korpusna provera je sišla sa početka na kraj i prestala da bude plafon — `NEMA` je postalo **`NEPOZNATO`**, jer nula pogodaka ima dva uzroka koja alat ne razlikuje: sprega nije srpska, ili je nova. Noseće linije se pišu u **tri različite opklade**, pa se bira. Rubrika je dobila **test potpisa**: ako tekst može da potpiše konkurent bez ijedne izmene, pada bez obzira na poene — izmereno, jer verzija bez ijednog profila dobija 90–93 i pobeđuje većinu profila. **v1.11.1** dodaje dva pravila koja su ispala iz prve verzije: izveštaj se ređa **po ceni greške, ne po broju mesta** (inače najskuplji nalaz završi pod „sitnije, ali vidljivo"), i **ista potvrđena sprega sme se upotrebiti jednom po tekstu** — inače rečnik radi kao štaka i lektura tekst učini ujednačenijim nego što je bio pre nje. **v1.11.2** donosi četiri pravila iz prvog stvarnog prolaza kroz sajt: pravno i regulatorno ima **nula** težine i ne ulazi u izveštaj; „cena greške" znači cena **tekstu**, ne firmi; **prekoračen prag zaustavlja isporuku** umesto da se prijavi kao statistika; i **slogan ne nosi osovinu** — izmereno na 25 domaćih slogana, korist saopštava njih šest, i sve su iz funkcionalnih kategorija;
