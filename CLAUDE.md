...
`SKILL.md` (~510 linija) je jedini fajl koji se uvek učitava; `references/*.md` (26 fajlova, ~2.800 linija) učitavaju se na zahtev preko linkova iz sekcije „Izbor radnog toka". Svaka tvrdnja koja uđe u `SKILL.md` troši kontekst na svakom pozivu skilla — zato tamo idu samo pravila koja važe za svaki zadatak, a specijalizovano ide u `references/`.
